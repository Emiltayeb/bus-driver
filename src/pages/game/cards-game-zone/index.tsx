...
import classes from "./card-game-zone.module.css"
...
*/}
		<div className={classes.GamePlatform}>
			Cards Game Zone
			{cardsInGame?.[level]?.length && cardsInGame[level].map(card => <Card stack={level === 1} key={card.value + card.suit} currentCard={card} />)}
		</div>
		{/* show level buttons */}
		<PlayingButtons />
	</div>
